...
# Structure of CNN
    def __init__(self):
        ...
        self.fc1 = nn.Linear(4*4*50,500)  # Linear equation (input,output)
        self.fc2 = nn.Linear(500,10)      # Linear equation (input,output)
        
# Functions for moving forward in the layers 
    def forward(self,x):
