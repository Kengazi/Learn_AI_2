...
# YOLO v3 current object detector fastest
...
# For loops for detecting
    for out in outs:
        for detection in out: # confidences
            scores = detection[5:] # Scores of detection
            class_id = np.argmax(scores) # Label 
...
cap.set(3,480) # shrink width of input video
cap.set(4,320) # shrink height of input video
a = 0 
