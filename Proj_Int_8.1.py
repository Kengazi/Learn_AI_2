...
The goal of this assignment is to get you comfortable with model analysis.
...
it hold the correctly predicted outputs. This is a great visual representation of the models limits.
...
# Taking data from the digits object
...
# Looping :: This for loop is mainly for showing the image
